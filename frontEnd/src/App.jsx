...
function App() {
  ...
  const propsObject = {
    planning: {
      formState, districts, onFieldChange: updateField, onSubmit: handleSubmit, loading, errorMessage, result,
      sessions, onSelectSession: handleSelectSession, activeFilter, onFilterChange: setActiveFilter,
