import { Sprout, Activity, Wheat, BadgeIndianRupee, Landmark, Crown, Brain, History, Settings, Home } from "lucide-react";
import { useTranslation } from "react-i18next";
import { NavLink } from "react-router-dom";

const PHASES = [
  { path: "/", label: "Dashboard", icon: Home },
  { path: "/planning", tKey: "nav.phase1", label: "Planning", icon: Sprout },
  { path: "/health", tKey: "nav.phase2", label: "Crop Health", icon: Activity },
